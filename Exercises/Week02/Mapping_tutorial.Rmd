...
meta_data <- read.csv("/Users/PM/Desktop/PHD_incomplete/PG2018/PG2018/Exercises/Week02/Sample_meta_data.csv", sep=";", header = TRUE)
...
## IGV software
IGV is a Integrative Genomics viewer and can be very useful to look at the results of Mapping and SNP calling.
...
![IGV brownser illustration](/Users/PM/Desktop/PHD_incomplete/PG2018/PG2018/Exercises/Week02/IGV_example.png)

Try to understand what are the different attributes present in the viewer. If you zoom in very much you will find single nucleotide polimorphisms (SNPs), where the reference sequence does not have the same nucleotide as the data mapped to.
